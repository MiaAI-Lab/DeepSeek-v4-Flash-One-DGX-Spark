...
#
# All tunables live in this file.  compose-180k.yaml is GENERATED — do not edit it.
...
cd "$SCRIPT_DIR"
export COMPOSE_FILE=compose-180k.yaml   # this variant's own compose file
...
ensure_compose() {
  [ -f compose-180k.yaml ] || generate_compose
}
